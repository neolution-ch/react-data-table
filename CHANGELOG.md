...
- Functions `getFilterState` to get current status of filters and `updateFilters` to update filters and refresh dataTable
...
[unreleased]: https://github.com/neolution-ch/react-data-table/compare/3.4.0...HEAD
